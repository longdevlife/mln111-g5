export default function CoSoLyThuyet() {
  ...
  const characteristics = [
    ...
    { t: '304.000 Tỷ', i: 'Vạn Thịnh Phát' }, { t: 'Giảm 46.5%', i: 'Nồng độ cồn' },
  ];
    ...
    <section id="co-so-ly-thuyet" className="relative w-full bg-[#E5E0D8] px-4 py-32 md:py-40 overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto mb-24 md:mb-32">
        <div className="gsap-reveal flex items-center gap-3 mb-6">
          ...
          <span className="text-[10px] uppercase tracking-[0.25em] font-semibold text-[#7A6040]" style={{ fontFamily: f2 }}>Phần 2</span>
        </div>
        <h2 className="text-5xl md:text-7xl font-bold tracking-tight text-[#3D3529] mb-8 leading-snug" style={{ fontFamily: f1 }}>
          ...
          <span className="gsap-text-reveal block italic font-light text-[#7A6040] pt-1">Thực Tiễn</span>
        </h2>
        <p className="gsap-reveal text-lg text-[#7A6040] max-w-2xl leading-relaxed font-light" style={{ fontFamily: f2 }}>
          Việc xây dựng Nhà nước pháp quyền XHCN tại Việt Nam trong bối cảnh hội nhập đạt nhiều thành tựu nhưng cũng đối mặt với không ít thách thức hiện hữu.
        </p>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto mb-32">
        <div className="gsap-reveal flex items-center gap-4 mb-16">
          <span className="text-sm tracking-[0.25em] text-[#7A6040]/60 uppercase font-semibold" style={{ fontFamily: f2 }}>Thực Trạng Hiện Nay</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="gsap-slide-left card-tilt group">
            <div className="h-full p-8 md:p-10 bg-white/50 rounded-[20px] border border-[#3D3529]/5 transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(61,53,41,0.08)]">
              <span className="text-[10px] uppercase tracking-[0.2em] text-[#7A6040]/50 mb-6 block font-semibold" style={{ fontFamily: f2 }}>Nhà nước hợp hiến, hợp pháp</span>
              <h3 className="text-3xl font-bold text-[#3D3529] mb-3" style={{ fontFamily: f1 }}>Tính Hợp Hiến & Uy Tín</h3>
              <span className="text-[#C5A028] text-sm font-medium mb-6 block italic" style={{ fontFamily: f1 }}>Bầu cử QH khóa XVI & HĐ Nhân quyền</span>
              <p className="text-[#7A6040] text-base leading-relaxed font-light mb-8" style={{ fontFamily: f2 }}>
                Bầu cử Quốc hội khóa XVI có 864 người ứng cử, xác nhận 500 đại biểu (27/3/2026). Việt Nam tái đắc cử Hội đồng Nhân quyền LHQ (2026–2028) với 180 phiếu ủng hộ, khẳng định tư cách pháp lý vững chắc trên trường quốc tế.
              </p>
              <div className="flex flex-wrap gap-2">
                {['500 Đại biểu', '180 Phiếu LHQ', 'Bầu cử 2026', 'Hợp hiến'].map(tag => (
          ...
          <div className="gsap-slide-right card-tilt group">
            <div className="h-full p-8 md:p-10 bg-[#3D3529] rounded-[20px] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_-15px_rgba(61,53,41,0.2)]">
              <span className="text-[10px] uppercase tracking-[0.2em] text-[#C5A028]/80 mb-6 block font-semibold" style={{ fontFamily: f2 }}>Pháp quyền nhân nghĩa</span>
              <h3 className="text-3xl font-bold text-[#EDE8E1] mb-3" style={{ fontFamily: f1 }}>Lấy Con Người Làm Trung Tâm</h3>
              <span className="text-[#C5A028] text-sm font-medium mb-6 block italic" style={{ fontFamily: f1 }}>Đại dịch COVID-19</span>
              <p className="text-[#EDE8E1]/70 text-base leading-relaxed font-light mb-8" style={{ fontFamily: f2 }}>
                Quyết định 23/2021/QĐ-TTg hỗ trợ lao động mất việc, kinh doanh khó khăn. Nghị quyết 168/NQ-CP xác định vaccine COVID-19 miễn phí cho toàn dân, ưu tiên nhóm nguy cơ cao.
              </p>
              <div className="flex flex-wrap gap-2">
                {['QĐ 23/2021/QĐ-TTg', 'Vaccine miễn phí', 'Hỗ trợ tiền mặt'].map(tag => (
            ...
            <div className="h-full p-8 md:p-10 bg-white/50 rounded-[20px] border border-[#3D3529]/5">
              ...
              <div className="pl-6 border-l-2 border-[#C5A028]">
                <p className="gsap-quote-highlight text-[#3D3529]/90 italic font-medium" style={{ 
                  ...
                  "Thượng tôn pháp luật không chỉ để xử phạt mà còn bảo vệ lợi ích nhân dân."
                </p>
              </div>
            </div>
          </div>
